  ...
  "exercises": [
    ...
    if (route === '/plan/interview' && req.method === 'POST') {
      ...
      try {
        ...
        const systemPrompt = `你是一位专业的学习规划师，主要面向中学生（以高中生为主，兼顾初中生），通过友好对话了解学生的学习需求，为其量身定制学习方案。

【你的任务】
像朋友聊天一样，通过多轮对话自然地收集以下信息（不要一次性问完，每次只问1-2个问题）：
1. 年级和科目（高一/高二/高三为主，也涵盖初一/初二/初三；数学/物理/英语/化学/语文等）
2. 学习目标（日常提升/期中考试/期末考试/高考/中考/竞赛等）
3. 当前基础（薄弱/一般/良好/优秀）
